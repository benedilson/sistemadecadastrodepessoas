...
import br.com.scp.model.Telefone;
...
public class TelefoneEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Telefone> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT t FROM Telefone t LEFT JOIN FETCH t.loginOperador LEFT JOIN FETCH t.idPessoa WHERE t.id = :entityId ORDER BY t.id",
						Telefone.class);
	...
	public List<Telefone> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Telefone> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT t FROM Telefone t LEFT JOIN FETCH t.loginOperador LEFT JOIN FETCH t.idPessoa ORDER BY t.id",
						Telefone.class);
